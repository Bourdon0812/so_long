...
/*   Updated: 2025/01/08 21:44:16 by ilbonnev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	init_render(t_game *game)
{
	...
	mlx = game->render.mlx;
	game->render.window = mlx_new_window(game->render.mlx, game->map.nbcol * TILE_SIZE, game->map.nbrow * TILE_SIZE, WINDOW_NAME);
